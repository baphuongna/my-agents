...
import { applyEditsToNormalizedContent, computeEditsDiff, detectLineEnding, generateDiffString, generateUnifiedPatch, normalizeToLF, restoreLineEndings, stripBom, } from "./edit-diff.ts";
...
export function createEditToolDefinition(cwd, options) {
    ...
    return {
        ...
        // Tool description already covers oldText uniqueness, no-overlap, and no-padding rules;
        // duplicating them in the system-prompt guidelines wastes ~100 prefix tokens per turn.
        promptGuidelines: [],
