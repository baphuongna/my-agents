...
import { modelsAreEqual } from "@my-agent/pi-ai";
...
import { resolveCliModel, resolveModelScope } from "./core/model-resolver.ts";
import { restoreStdout, takeOverStdout } from "./core/output-guard.ts";
import { resolveProjectTrusted } from "./core/project-trust.ts";
import { formatMissingSessionCwdPrompt, getMissingSessionCwdIssue, MissingSessionCwdError, } from "./core/session-cwd.ts";
...
export async function main(args, options) {
    ...
    if (gatewaySession) {
        ...
        sessionAny.prompt = async (_text, _options) => {
