...
import type { AssistantMessage, Model } from "@my-agent/pi-ai";
...
vi.mock("@my-agent/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@my-agent/pi-ai/compat")>();
	return {
		...actual,
