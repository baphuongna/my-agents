...
import { Agent, type AgentEvent, type AgentTool } from "@my-agent/pi-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@my-agent/pi-ai/compat";
