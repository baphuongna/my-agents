 ...
 *
 * This module was relocated from packages/coding-agent/src/core/subagent.ts
 * (now consumed from @earendil-works/pi-coding-agent on npm). The only
 * change is the createAgentSession import source.
 */
