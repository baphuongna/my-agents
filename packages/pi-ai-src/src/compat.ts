 ...
 *
 * Existing apps switch imports from "@my-agent/pi-ai" to
 * "@my-agent/pi-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@my-agent/pi-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@my-agent/pi-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@my-agent/pi-ai/providers/all" or `Models.getProviders()`. */
